  ...
  return (
    ...
    <div className='w-full max-w-sm bg-white m-auto flex justify-center  flex-col p-4'>
      ...
      <form className='w-full py-3 flex flex-col' onSubmit={handleSubmit}>
        ...
        <button className='w-full max-w-[150px] m-auto  bg-red-600 hover:bg-red-600 cursor-pointer text-white text-xl font-medium text-center py-1 rounded-full mt-4'>Login</button>
      </form>
      <p className='text-left text-sm mt-2'>Não tem uma conta? <Link to={"/signup"} className="text-red-500 underline">Cadastre-se</Link></p>
    </div>
</div>
  )
}
